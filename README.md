...
Reference platform: Ubuntu 24.04 LTS, Go 1.27.1; see [below](https://github.com/marcfrei/scion-time/edit/main/README.md#installing-prerequisites-for-a-scion-test-environment).
...
Reference platform: Ubuntu 24.04 LTS, Go 1.27.1
...
curl -LO https://golang.org/dl/go1.27.1.linux-amd64.tar.gz
...
```
sudo rm -rf /usr/local/go
curl -LO https://golang.org/dl/go1.27.1.linux-arm64.tar.gz
echo "3450b45a3f9ee8568792736a5c5e70a1f2e9b36c35a8f74958c03e51d7d92bec go1.27.1.linux-arm64.tar.gz" | sha256sum -c
